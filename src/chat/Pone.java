...
class User {
 ...
 public	User(String u,InetSocketAddress ad){
		Username=u;
		location=ad;
	}
 @Override
 public boolean equals(Object other){
	 ...
	 if(other == this) 
		 return true;
	 User rhs=(User) other;
	 if(Username.equals(rhs.Username) && location.equals(rhs.location))
		 return true;
	 return false;
 ...
 public int hashCode(){
	 int hash=3;
	 hash=hash*7+Username.hashCode();
	 hash=hash*7+location.hashCode();
	 return hash;
 }
 @Override
 public String toString(){
	 return Username+" "+location.toString();
 }
